...
<main id="contact">
  <article class="firstRow">
    ...
    <div class="pic">
      <a href="/" class="nav-link close"><svg><use xlink:href="images/sprite.svg#back"></use></svg></a>
      <img src="images/profile-picture-square.jpg" alt="François-Xavier Aeberhard" class="img-fluid" />
    </div>
    <div class="coord">
      <h1>François-Xavier Aeberhard</h1>
      <h2>Level 110 User Experience Engineer</h2>
      <div class="links link-effect">
        <a href="mailto:fx@red-agent.com"><svg><use xlink:href="images/sprite.svg#mail"></use></svg>fx@red-agent.com</a>
        <a href="tel:41798532679"><svg><use xlink:href="images/sprite.svg#phone"></use></svg>+41 79 853 26 79</a>
      </div>
      <div class="online">
  ...
  <article class="secrow">
    <div>
      ...
      <div>
        <div>
          <div>
            <svg><use xlink:href="images/sprite.svg#html"></use></svg>
            <strong>Web</strong>
          </div>
        </div>
        <div>
          <div data-width="100">AngularJS, React, Backbone, Sencha, D3, Scss, Less, Bootstrap</div>
        </div>
      </div>
      <div>
        <div>
          <div>
            <svg><use xlink:href="images/sprite.svg#server"></use></svg>
            <strong>Server</strong>
          </div>
        </div>
        <div>
          <div data-width="95">Java EE, Node.js, Ruby on Rails, Php, Pyhon</div>
        </div>
      </div>
      <div>
        <div>
          <div>
            <svg><use xlink:href="images/sprite.svg#pad"></use></svg>
            <strong>Client</strong>
          </div>
        </div>
        <div>
          <div data-width="90">C, C++, Wii, PS3, SDK, UDK, Unity </div>
        </div>
      </div>
      <div>
        <div>
          <div>
            <svg><use xlink:href="images/sprite.svg#cg"></use></svg>
            <strong>CG</strong>
          </div>
        </div>
        <div>
          <div data-width="80">WebGL, OpenGL, SDL, DirectX</div>
        </div>
      </div>
      <div>
        <div>
          <div>
            <svg><use xlink:href="images/sprite.svg#db"></use></svg>
            <strong>DB</strong>
          </div>
        </div>
        <div>
          <div data-width="60">Mongo, MySQL, PostgreSQL</div>
        </div>
      </div>
    </div>
    <div class="message">
